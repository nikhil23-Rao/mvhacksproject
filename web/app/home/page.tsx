...
export default function Dashboard() {
  ...
  const leaderboardData = [
    { name: "Me", points: 450 },
    { name: "Nikhil R.", points: 334 },
    { name: "Prayag G.", points: 127 },
  ];
 ...
 if (focusMode) {
    return (
      <>
        ...
        >
          {/* Exit Focus Mode X icon, top right of page */}
          <button
            aria-label="Exit Focus Mode"
            onClick={() => setFocusMode(false)}
            className="fixed top-6 right-8 z-[100] text-red-500 hover:text-red-700 transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-red-400 bg-white/80 rounded-full p-2 shadow-lg"
            style={{ fontSize: 32, lineHeight: 1, border: "none", background:"transparent" }}
          >
            <span style={{ fontWeight: 900, fontSize: 32, display: 'inline-block', lineHeight: 1 }}>×</span>
          </button>
          <div
            style={{
              display: "flex",
          ...
          >
            <div style={{ position: "absolute", top: 40 }}>
              ...
              >
                <section className="w-full max-w-lg mx-auto p-8 rounded-3xl shadow-2xl bg-gradient-to-br from-blue-900 via-blue-700 to-cyan-400 border-4 border-cyan-300/60 flex flex-col items-center gap-4 focus-mode-clock">
                  <span className="uppercase tracking-widest text-xs font-bold text-cyan-100/80 drop-shadow-md mb-2">
                    Current Time
                  </span>
                  <h1
                    className="text-6xl md:text-7xl font-extrabold text-white drop-shadow-lg select-none"
                    style={{ fontFamily: "", letterSpacing: 2 }}
                  >
                    {formatAMPM(time)}
                  </h1>
                </section>
          ...
          <>
            ...
            >
              ...
              >
                ...
                <h1
                  // className="text-gradient-black"
                  style={{ fontSize: "2vw", marginTop: 15, color: "#fff" }}
                >
                  My Folders
                </h1>
                <em><p
            ...
            >
              <div style={{ color: "#fff", padding: 20, position: "relative" }}>
                <button
                  aria-label="Close leaderboard"
                ...
                <em><p style={{ marginBottom: 20, color: "gray" }}>Top Coral Points</p></em>
                  ...
                  {leaderboardData.map((p, idx) => (
                    <li
                      ...
                      style={{
                        ...
                        maxWidth: 400,
                        border: "2px solid",
                        borderImage: "linear-gradient(to right, #4facfe, #00f2fe)",
                        borderImageSlice: 1,
                        padding: 10,
                        borderRadius: 8,
                      }}
            ...
            >
              ...
              >
                <ul className="infographic-cards" style={{ marginTop: 50 }}>
                  <li className="color-2" onClick={() => setDrawingModal(true)}>
                    <i className="fa fa-paint-brush"></i>
