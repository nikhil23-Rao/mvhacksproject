...
interface IProps {
  ...
  color?: string;
  showCoralModal?: boolean;
  currentCoralImage?: string;
  handleCoralResponse?: (response?: string) => void;
  showCoralFunFact?: boolean;
  currentCoralFunFact?: string;
  theme?: any;
}
...
export const Flipper = ({
  ...
  setQuizletModal,
  color,
  showCoralModal = false,
  currentCoralImage = "",
  handleCoralResponse = () => {},
  showCoralFunFact = false,
  currentCoralFunFact = "",
  theme,
}: IProps) => {
  return (
    <div>
      ...
      {showCoralModal ? (
        <div style={{ textAlign: "center", padding: "30px" }}>
          <h2 style={{ fontSize: "1.5em", marginBottom: "20px", fontWeight: "400", color }}>
            {showCoralFunFact ? "Fun Fact Time!" : "To continue studying, answer the following question:"}
          </h2>
          <img
            src={currentCoralImage}
            alt="Coral"
            style={{ 
              width: "100%", 
              maxWidth: "300px", 
          ...
          {showCoralFunFact ? (
            <>
              <p style={{ fontSize: "1.2em", marginBottom: "30px", fontWeight: "500", color, lineHeight: "1.6" }}>
                {currentCoralFunFact}
              </p>
              <button 
            ...
            <>
              <p style={{ fontSize: "1.2em", marginBottom: "30px", fontWeight: "500", color }}>
                Has this coral been bleached?
              </p>
              <div style={{ display: "flex", justifyContent: "center", gap: "20px" }}>
                <button 
                  ...
                  onClick={() => handleCoralResponse("Yes")}
                >
                  Yes
                </button>
                <button 
                  ...
                  onClick={() => handleCoralResponse("No")}
                >
                  No
                </button>
              </div>
